...
Shiny Applikationen beruhen im weitestgehend auf die zur Verfügungstellung von *input* Werten, Bereitstellung dieser in *R* und Rücksendung der evaluierten R Objekte als *output* zur Webseite.
...
Ein *input* Objekt kann mit mehreren *output* Objekten verbundensein und umgekehrt.
...
Eine Erweiterung zu den standard Shiny_layoutimplementierungen bietet das Paket `shinydashboard` an:
...
Es stehen mehrere Ebenen zur Implementierung der interaktiver Grafiken zur Verfügung:
